        ...
        if(cashBoxOptional.isPresent()){
            ...
            if(operations == Operations.SUBTRACT){
                switch (replenishModel.getCurrency()) {
                    ...
                    case EURO -> cashBox.setCurrentBalanceEURO(subtractOperation(replenishModel.getReplenishAmount(), cashBox.getCurrentBalanceSOM()));
                    case DOLLAR -> cashBox.setCurrentBalanceUSD(subtractOperation(replenishModel.getReplenishAmount(), cashBox.getCurrentBalanceSOM()));
                }
                ...
                switch (replenishModel.getCurrency()) {
                    ...
                    case EURO -> cashBox.setCurrentBalanceEURO(additionOperation(replenishModel.getReplenishAmount(), cashBox.getCurrentBalanceSOM()));
                    case DOLLAR -> cashBox.setCurrentBalanceUSD(additionOperation(replenishModel.getReplenishAmount(), cashBox.getCurrentBalanceSOM()));
                }
            }
